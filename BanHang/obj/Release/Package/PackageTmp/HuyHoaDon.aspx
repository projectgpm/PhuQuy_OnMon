<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="HuyHoaDon.aspx.cs" Inherits="BanHang.HuyHoaDon" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Danh sách hóa đơn đã hủy" PostBackUrl="DanhSachHoaDonDaHuy.aspx">
    ...
    <CellStyle HorizontalAlign="Center"></CellStyle>
        ...
        <Columns>
            <dx:GridViewCommandColumn ShowClearFilterButton="True" ShowDeleteButton="True" VisibleIndex="6" Name="chucnang">
