...
namespace BanHang.Data
{
    public class dtKiemKho
    {
        ...
        public static int LayTrangThaiKiemKho(string ID,string IDKho)
        {
            using (SqlConnection con = new SqlConnection(StaticContext.ConnectionString))
            {
                con.Open();
                string cmdText = "SELECT TrangThai FROM [GPM_KiemKho] WHERE [ID] = '" + ID + "' AND [IDKho] = " + IDKho;
        ...
        public void ThemPhieuKiemKho_Temp(string IDPhieuKiemKho, string IDHangHoa, double TonKho, double ChenhLech,string MaHang, string IDDonViTinh)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                try
        ...
        public void CapNhatPhieuKiemKho_Temp(string ID, double ThucTe, double ChenhLech)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                try
        ...
        public void CapNhatPhieuKiemKho(object ID, string IDNguoiDung, DateTime NgayKiemKho, string IDKho, string GhiChu)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                ...
                {
                    myConnection.Open();
                    string cmdText = "UPDATE [GPM_KiemKho] SET [IDNguoiDung] = @IDNguoiDung, [NgayKiemKho] = @NgayKiemKho, [IDKho] = @IDKho, [GhiChu] = @GhiChu WHERE [ID] = @ID";
                    using (SqlCommand myCommand = new SqlCommand(cmdText, myConnection))
                    {
                        myCommand.Parameters.AddWithValue("@ID", ID);
        ...
        public void ThemPhieuKiemKho(object IDPhieuKiemKho, string IDHangHoa, string TonKho, string ChenhLech, string ThucTe, string MaHang, string IDDonViTinh,string IDKe)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                ...
                {
                    myConnection.Open();
                    string cmdText = "INSERT INTO [GPM_KiemKho_ChiTiet] ([IDPhieuKiemKho],[IDHangHoa],[TonKho],[ChenhLech],[ThucTe],[MaHang],[IDDonViTinh],[IDKe]) VALUES (@IDPhieuKiemKho,@IDHangHoa,@TonKho,@ChenhLech,@ThucTe,@MaHang,@IDDonViTinh,@IDKe)";
                    using (SqlCommand myCommand = new SqlCommand(cmdText, myConnection))
                    {
