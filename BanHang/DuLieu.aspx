...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" Width="100%" Height="350px"
        TabAlign="Justify" ActiveTabIndex="8" EnableTabScrolling="true">
...
<TabImage IconID="data_deletedatasource_16x16office2013"></TabImage>
            ...
            <dx:TabPage Text="Đơn Vị Tính">
             ...
             <dx:TabPage Text="Vùng">
                <ContentCollection>
                    <dx:ContentControl ID="ContentControl8" runat="server">
                        <dx:ASPxButton ID="gridVung_btnVungXoaTatCa" runat="server" Text="Xóa tất cả" OnClick="gridVung_btnVungXoaTatCa_Click">
                            <Image IconID="actions_cancel_16x16">
                            </Image>
                        </dx:ASPxButton>
                        <dx:ASPxGridView ID="gridVung" runat="server" AutoGenerateColumns="False" Width="100%" KeyFieldName="ID" OnCustomButtonCallback="gridVung_CustomButtonCallback" >
                            <Settings ShowTitlePanel="True" />
                            <SettingsBehavior ConfirmDelete="True" />
                            ...
                            <SettingsText ConfirmDelete="Chú ý. Dữ liệu sẽ xóa vĩnh viễn khỏi hệ thống" Title="Danh Sách Vùng Đã Xóa Trước Đó" />
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="Mã Vùng" FieldName="MaVung" ShowInCustomizationForm="True" VisibleIndex="0">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewCommandColumn  VisibleIndex="8" ButtonRenderMode="Image" ButtonType="Image">
                                    <CustomButtons>
                                        <dx:GridViewCommandColumnCustomButton ID="gridVung_KhoiPhuc">
                                            <Image IconID="scheduling_recurrence_16x16" ToolTip="Khôi phục">
                                    </Image>
                                         
                                        </dx:GridViewCommandColumnCustomButton>
                                        <dx:GridViewCommandColumnCustomButton ID="gridVung_Xoa" >
                                             <Image IconID="actions_close_16x16" ToolTip="Xóa" >
                                    </Image>
                                ...
                                <dx:GridViewDataTextColumn Caption="Tên Vùng" FieldName="TenVung" ShowInCustomizationForm="True" VisibleIndex="1">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Ghi Chú" FieldName="GhiChu" ShowInCustomizationForm="True" VisibleIndex="2">
                                </dx:GridViewDataTextColumn>
                            </Columns>
                             <Styles>
                                <Header Font-Bold="True" HorizontalAlign="Center">
             ...
             <dx:TabPage Text="Kho">
                <ContentCollection>
                    <dx:ContentControl ID="ContentControl10" runat="server">
                        <dx:ASPxButton ID="gridKho_btnXoa" runat="server" Text="Xóa tất cả" OnClick="gridKho_btnXoa_Click" >
                            <Image IconID="actions_cancel_16x16">
                            </Image>
                        </dx:ASPxButton>
                        <dx:ASPxGridView ID="gridKho" runat="server" AutoGenerateColumns="False" Width="100%" KeyFieldName="ID" OnCustomButtonCallback="gridKho_CustomButtonCallback" >
                            <Settings ShowTitlePanel="True" />
                            <SettingsBehavior ConfirmDelete="True" />
                            ...
                            <SettingsText ConfirmDelete="Chú ý. Dữ liệu sẽ xóa vĩnh viễn khỏi hệ thống" Title="Danh Sách Kho Đã Xóa" />
                            <Columns>
                                ...
                                <dx:GridViewCommandColumn  VisibleIndex="8" ButtonRenderMode="Image" ButtonType="Image" Name="chucnang">
                                    <CustomButtons>
                                        ...
                                        <dx:GridViewCommandColumnCustomButton ID="gridKho_Xoa" >
                                             <Image IconID="actions_close_16x16" ToolTip="Xóa" >
                                    </Image>
                                ...
                                <dx:GridViewDataTextColumn Caption="Tên Kho" FieldName="TenCuaHang" ShowInCustomizationForm="True" VisibleIndex="1">
                                </dx:GridViewDataTextColumn>
