...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="Loại thu chi">
                <Items>
                            ...
                            <dx:LayoutItemNestedControlContainer runat="server">
                                ...
                                <SettingsCommandButton>
                                    ...
                                    <UpdateButton Text="Lưu">
                                        <Image IconID="save_save_32x32office2013" ToolTip="Lưu" AlternateText="Lưu">
                                        </Image>
                                    </UpdateButton>
                                    <CancelButton>
                                ...
                                <SettingsText CommandDelete="Xóa" CommandEdit="Sửa" CommandNew="Thêm" ConfirmDelete="Bạn có chắc chắn muốn xóa không?" PopupEditFormCaption="Thông tin đơn vị tính" EmptyDataRow="Danh sách trống." SearchPanelEditorNullText="Nhập thông tin cần tìm..." />
                                 <EditFormLayoutProperties>
                                     <Items>
                                         <dx:GridViewColumnLayoutItem Caption="Loại chi phí" ColumnName="Tên thu chi" Name="TrangThai">
                                 ...
                                 <Columns>
                                     ...
                                     <dx:GridViewDataTextColumn Caption="Tên thu chi" FieldName="TrangThai" VisibleIndex="3">
                                     </dx:GridViewDataTextColumn>
